...
export default defineSchema({
  ...
  expenses: defineTable({
    ...
    linkedGoalIds: v.optional(v.array(v.id("savingsGoals"))), // Link expenses to savings goals
  })
  ...
  recurringContributions: defineTable({
    goalId: v.id("savingsGoals"),
    amount: v.number(),
    contributorId: v.id("users"),
    frequency: v.string(), // "weekly", "monthly", "yearly"
    startDate: v.string(),
    endDate: v.optional(v.string()),
    isActive: v.boolean(),
    lastContributedDate: v.optional(v.string()),
    nextDueDate: v.string(),
    note: v.optional(v.string()),
  }).index("by_goal", ["goalId"])
